<div id="div" class="div-site">
    ...
    <div class="container">
        ...
        <div class=" div-content-area">
            ...
            @endif
            <div class="mb-4 border-b-4 border-black">

                @if (Cart::count() > 0)

                    <div class="">
                        <h3 class="my-3 text-3xl">Lista de Productos</h3>
                        <ul class="">
                            @foreach (Cart::content() as $item)
                                <li class="flex items-center justify-between mb-3">
                                    ...
                                    {{-- boton elimnar --}}
                                    <div class="delete">
                                        <a wire:click.prevent="destroy('{{ $item->rowId }}')" class="btn btn-delete"
                                            title="">
        ...
        <div class="">
            <div class="flex justify-end pb-4 border-b-4 border-black">
                <div class="w-72 ">
                    <div class="flex">
                        <p class="w-48 font-semibold">Subtotal</p>
                        <p class=" font-semibold">${{ Cart::subtotal() }}</p>
                    </div>
                    <div class="flex">
                        <p class="w-48 font-semibold">Tax</p>
                        <p class=" font-semibold">${{ Cart::tax() }}</p>
                    </div>
                    <div class="flex">
                        <p class="w-48 font-semibold">Total</p>
                        <p class=" font-semibold">${{ Cart::total() }}</p>
                    </div>
                </div>
            </div>

            <div class="my-2 border-b-4 border-black pb-2" >
                <a href="{{ route('checkout')}}"class=" block text-center bg-red-500 w-full py-2 font-black text-xl rounded rounded-lg hover:bg-red-700 text-white">
                    checkout
                </a>
            </div>
        ...
        <div>
            <p class="text-3xl font-bold my-4 ">Productos Populares</p>
